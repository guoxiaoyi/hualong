WizcmsArticle::ArticleCategory.seed(:id,
  {id: 1, name: '英文新闻', custom_order: '', parent_id: 0, brief: '英文新闻', published: 1, cite_key: 'en_news'},
  {id: 2, name: '英文通知', custom_order: '', parent_id: 0, brief: '英文通知', published: 1, cite_key: 'en_notice'},
  {id: 3, name: '日文新闻', custom_order: '', parent_id: 0, brief: '日文新闻', published: 1, cite_key: 'jp_news'},
  {id: 4, name: '日文通知', custom_order: '', parent_id: 0, brief: '日文通知', published: 1, cite_key: 'jp_notice'},
  {id: 5, name: '中文新闻', custom_order: '', parent_id: 0, brief: '中文新闻', published: 1, cite_key: 'zh_news'},
  {id: 6, name: '中文通知', custom_order: '', parent_id: 0, brief: '中文通知', published: 1, cite_key: 'zh_notice'}
)
WizcmsArticle::Page.seed(:id,
  {id: 1, title: '牛肉面历史', content: '遙か昔、唐の時代には中国料理はすでに繊細といえる領域にまで高められていた。しかし大食いである東の地区の人々は、穀物と牛骨スープの中に美味しさと栄養を探し求め続けた。牛骨を煮つめスープをとり、穀物を曳き粉にし、弾力と粘り強さを持たせる。牛肉拉麺はここに始まり、中国全土を風靡し、やがては海外にまで広がっていった。現代、金味徳の作る牛肉拉麺は当時の味を追い求め、古くから伝わる方法でスープを取り麺を伸ばし、さらに独自の創意工夫によって改良された正統派の蘭州牛肉拉麺であると言える。これは一杯の拉麺の物語だが、脈脈と続く文明の探究と進展でもある。', published: 1, cite_key: 'jp_history', keywords: '', brief: 'history', parent_id: ''},
  {id: 2, title: '学术委员会', content: '联系我们联系我们', published: 1, cite_key: 'en_history', keywords: '', brief: 'learning', parent_id: ''},
  {id: 3, title: '企业委员会', content: '联系我们联系我们', published: 1, cite_key: 'zh_history', keywords: '', brief: 'enterprise', parent_id: ''},
  {id: 4, title: '联系我们', content: '', published: 1, cite_key: 'en_contact_us', keywords: '', brief: 'contact_us', parent_id: ''},
  {id: 5, title: '联系我们', content: '<strong>地址:東京都港区六本木7-14-1 1F</strong><br>営業時間】11：00〜22：00 <br>※牛肉麺の食感を保証するために、ラーメンが売り切れて当日営業を停止しますので、ご了承ください。<br>
    <span>電話 03-6811-7992<br></span>', published: 1, cite_key: 'jp_contact_us', keywords: '', brief: 'contact_us', parent_id: ''},
  {id: 6, title: '联系我们', content: '联系我们联系我们', published: 1, cite_key: 'cn_contact_us', keywords: '', brief: 'contact_us', parent_id: ''}
)
...
ProductCategory.seed(:id,
  {id: 1, en_title: "", zh_title: "中文产品", cid: 1},
  {id: 2, en_title: "", zh_title: "英文产品", cid: 2},
  {id: 3, en_title: "", zh_title: "日文产品", cid: 3},
)